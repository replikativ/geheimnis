(ns org.replikativ.geheimnis.rsa
  "This namespace provides an RSA implementation."
  (:require [org.replikativ.hasch.core :refer [edn-hash]]
            [org.replikativ.geheimnis.base64 :as b64]
            #?(:cljs [cljs.reader :as r])))

(defrecord RSAKey [pub-key priv-key modulus])

#?(:clj
   (defmethod print-method org.replikativ.geheimnis.rsa.RSAKey
